...
**Description:**
The "Discover" nav item is selected by default on the search results page. It has a lighter background color when selected. The result is an insufficient color contrast of 3.49:1 between the text and the background. According to WCAG 2.2 AA, the contrast should be 4.5:1 for normal size text.
...
**WCAG 2.1 SC:** WCAG 2.2 — 1.4.3 Contrast (Minimum) (Level AA)  
**Severity:** Medium
