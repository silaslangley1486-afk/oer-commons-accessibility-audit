...
## Description: There are multiple links in each search result. These links are distinguished only by a blue color. They are only underlined on hover, which is not available to all users.
...
**WCAG 2.2 SC:** WCAG 2.2 — 1.4.1 Use of Color (Level A)  
**Severity:** Medium
