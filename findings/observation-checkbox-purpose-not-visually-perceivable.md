...
On the Search Resources page, the purpose of the checkbox in the row of controls below the Search Results header is unclear for sighted readers. There is no visual way to perceived what the checkbox does. It can however be programmitcally determined through a screen reader since it has an `aria-label`.
